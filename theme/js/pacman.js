...
pacman.model = {
    ...
    renderPoints: function(p) {
        document.getElementById("point-counter").innerHTML = "Skóre: " + p;
    },
...
pacman.engine = {
    ...
    hideResultView: function() {
        document.getElementById("result-view").className = "d-none";
    ...
    showResultView: function(msg) {
        ...
        var html = "<tr> <th>Meno</th> <th>Skóre</th> <th>Čas</th> </tr>";
    ...
    tick: function() {
        ...
        if (status === pacman.engine.magic.CONTINUE) {
            ...
            pacman.engine.showResultView("Prehral si! Tvoje skóre je " + pacman.model.points + " bodov.");
        } else if (status === pacman.engine.magic.VICTORY) {
            pacman.model.addEntry();
            pacman.engine.showResultView("Vyhral si! Tvoje skóre je " + pacman.model.points + " bodov.");
        }
...
function initGame(username) {
    ...
    document.getElementById("welcome").className = "d-none";
...
function initWelcomeView() {
    ...
    document.getElementById("pmcanvas").className = "d-none";
